...
class backendStack(cdk.Stack):
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        rek_fn = lb.Function(
            self,
            "rekognitionFunction",
            code=lb.Code.from_asset("rekognitionFunction"), ## here, "rekognitionFunction" is the folder path in your project directory where you have defined lambda function, CDK creates a zip file of our code and run it in the runtime env
